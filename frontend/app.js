...
function buildIndexPages() {
    ...
    const linalgTopics = [
        ...
        { id: 'la-eigen',      title: 'Eigenvectors',            desc: 'Watch iron filings align to magnetic eigen-lines. Use the built-in oscilloscope to detect zero-crossing directions of non-rotation.' },
        { id: 'la-complex',    title: 'Complex Eigenvalues',     desc: 'Understand why complex eigenvalues are necessary for stability by balancing a physical inverted pendulum.' }
    ];
...
document.querySelectorAll('.nav-link').forEach(link => {
    link.addEventListener('click', e => {
        ...
        if (link.dataset.page === 'la-eigen') { if(window.initLAEigen) initLAEigen(); }
        if (link.dataset.page === 'la-complex') { if(window.initLAComplex) initLAComplex(); }
